...
namespace Documentación
{
    ...
    [HelpFileBuilderPlugInExport("Documentación", Version = AssemblyInfo.ProductVersion,
      Copyright = AssemblyInfo.Copyright, Description = "Documentación plug-in")]
    public sealed class DocumentaciónPlugIn : IPlugIn
    {
        ...
        public void Execute(ExecutionContext context)
        {
            ...
            builder.ReportProgress("In DocumentaciónPlugIn Execute() method");
        }
        #endregion
